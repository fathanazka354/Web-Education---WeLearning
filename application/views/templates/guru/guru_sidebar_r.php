...
<div class="col-md-3 border-left pl-4">
    ...
    <div class="row mb-3">
        <div>
            ...
            <div class="mb-2"><?= $jml_user_login ?> online users (5 minutes)</div>

            <table class="table table-borderless">
                <tbody>
                    <?php foreach ($guru as $l) : ?>
                        <tr>
                            <td>
                                <div class="circle-row d-flex justify-content-center align-item-center" style="width: 30px; height:30px; background-color:tomato; border-radius:50%;">
                                    <div class="circle text-light">F</div>
                                </div>
                            </td>
                            <td>
            ...
            <button type="button" class="btn-link text-gray-600 px-1 bg-transparent" data-toggle="modal" data-target="#modalUser" style="border: none">Other Users (12 Users)</button>
            <!-- Modal -->
    ...
    <div class="row my-4">
        <div>
            <h5 class="font-weight-bold text-dark mb-3">Schedule Today</h5>
            <div class="row my-2" style="display: block">
                <div class="card border-left-warna-1 ml-3 mr-4" style="width: 100%">
                    <div class="card-body">
                        <div class="row my-2" style="color: #90e0ef">
                            <div class="col-1">
                                <i class="far fa-clock"></i>
                            </div>
                            <div class="col-10">Mon, 10 Jan | 07.15</div>
                        </div>
                        Biologi Lintas Minat 10 IPS 1
                    </div>
                </div>
            </div>
            <div class="row my-2" style="display: block">
                <div class="card border-left-warna-2 ml-3 mr-4" style="width: 100%">
                    <div class="card-body">
                        <div class="row my-2" style="color: #ffdd00">
                            <div class="col-1">
                                <i class="far fa-clock"></i>
                            </div>
                            <div class="col-10">Mon, 10 Jan | 09.45</div>
                        </div>
                        Biologi 10 IPA 4
                    </div>
                </div>
            ...
            <div class="row my-2" style="display: block">
                <div class="card border-left-warna-3 ml-3 mr-4" style="width: 100%">
                    <div class="card-body">
                        <div class="row my-2" style="color: #e0aaff">
                            <div class="col-1">
                                <i class="far fa-clock"></i>
                            </div>
                            <div class="col-10">Mon, 10 Jan | 12.20</div>
                        </div>
                        Biologi 11 IPA 5
                    </div>
                </div>
